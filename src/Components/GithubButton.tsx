...
function GithubIcons(props: React.ComponentPropsWithoutRef<'svg'>){
   return(
      <svg
       viewBox="0 0 15 15"
       fill="none"
...
export function GithuhButton(props: ButtonProps & React.ComponentPropsWithoutRef<'button'>) {
  ...
  return <Button onClick={handleAuth} leftSection={<GithubIcons/>} variant='default' {...props} className="w-1/2 rounded-full border bg-zinc-800 text-white"/>
}